...
window.__pkg__bundleSrc__['104']=function(){
    ...
    // 内置框架
    framework: function () {
        return window.__pkg__getLazyBundle('./dist/main-v0.3.0-bundle37.js','105')
    },

    // 代码编辑器
    editor: function () {
        return window.__pkg__getLazyBundle('./dist/main-v0.3.0-bundle38.js','106')
    },

    // WebGL
    webgl: function () {
        return window.__pkg__getLazyBundle('./dist/main-v0.3.0-bundle39.js','107')
    },

    // canvas
    canvas: function () {
        return window.__pkg__getLazyBundle('./dist/main-v0.3.0-bundle40.js','108')
    },

    // 颜色选择器
    "color-picker": function () {
        return window.__pkg__getLazyBundle('./dist/main-v0.3.0-bundle41.js','109')
    },

    // svg
    svg: function () {
        return window.__pkg__getLazyBundle('./dist/main-v0.3.0-bundle42.js','110')
    }
};
