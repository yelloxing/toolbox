...
window.__pkg__bundleSrc__['240']=function(){
    ...
    // 键盘练习
    "keyboard": function () {
        return window.__pkg__getLazyBundle('./dist/main-v0.3.1-bundle61.js','241')
    },

    // 英文打字
    "english": function () {
        return window.__pkg__getLazyBundle('./dist/main-v0.3.1-bundle62.js','242')
    },

    // 拼音打字
    "pinyin": function () {
        return window.__pkg__getLazyBundle('./dist/main-v0.3.1-bundle63.js','243')
    }
};
