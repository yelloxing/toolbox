...
window.__pkg__bundleSrc__['251']=function(){
    ...
    // 简单的饼图
    "pie-simple": function () {
        return window.__pkg__getLazyBundle('./dist/bundle-v0.3.4-bundle57.js','252')
    },

    // 多X轴折线图
    "line-multiple-x-axis": function () {
        return window.__pkg__getLazyBundle('./dist/bundle-v0.3.4-bundle58.js','253')
    },

    // 极坐标下的柱状图
    "bar-polar-real-estate": function () {
        return window.__pkg__getLazyBundle('./dist/bundle-v0.3.4-bundle59.js','254')
    },

    // 渐变气泡图
    "scatter-bubble-gradient": function () {
        return window.__pkg__getLazyBundle('./dist/bundle-v0.3.4-bundle60.js','255')
    },

    // 基础K线图
    "candlestick-simple": function () {
        return window.__pkg__getLazyBundle('./dist/bundle-v0.3.4-bundle61.js','256')
    },

    // 气压表
    "gauge-barometer": function () {
        return window.__pkg__getLazyBundle('./dist/bundle-v0.3.4-bundle62.js','257')
    },

    // 旭日图使用视觉编码
    "sunburst-visualMap": function () {
        return window.__pkg__getLazyBundle('./dist/bundle-v0.3.4-bundle63.js','258')
    },

    // 基础平行坐标
    "parallel-simple": function () {
        return window.__pkg__getLazyBundle('./dist/bundle-v0.3.4-bundle64.js','259')
    },

    // 金额波浪球
    "money-schedule": function () {
        return window.__pkg__getLazyBundle('./dist/bundle-v0.3.4-bundle65.js','260')
    },

    // 水分子式H2O
    "h2o": function () {
        return window.__pkg__getLazyBundle('./dist/bundle-v0.3.4-bundle66.js','261')
    }
};
