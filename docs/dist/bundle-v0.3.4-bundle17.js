...
window.__pkg__bundleSrc__['178']=function(){
    ...
    // 画布或图像大小
    size: function () {
        return window.__pkg__getLazyBundle('./dist/bundle-v0.3.4-bundle49.js','179')
    },

    // 保存
    save: function () {
        return window.__pkg__getLazyBundle('./dist/bundle-v0.3.4-bundle50.js','180')
    }
...
window.__pkg__bundleSrc__['181']=function(){
    ...
    // 工具箱
    tool: function () {
        return window.__pkg__getLazyBundle('./dist/bundle-v0.3.4-bundle51.js','182')
    },

    // 图层
    layer: function () {
        return window.__pkg__getLazyBundle('./dist/bundle-v0.3.4-bundle52.js','183')
    }
