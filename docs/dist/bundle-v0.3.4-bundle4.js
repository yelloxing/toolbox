...
window.__pkg__bundleSrc__['65']=function(){
    ...
    // 快速开始
    begin: function () {
        return window.__pkg__getLazyBundle('./dist/bundle-v0.3.4-bundle12.js','66')
    },

    // 右侧工具
    tools: function () {
        return window.__pkg__getLazyBundle('./dist/bundle-v0.3.4-bundle13.js','67')
    }
};
