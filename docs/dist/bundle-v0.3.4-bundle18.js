...
window.__pkg__bundleSrc__['187']=function(){
    ...
    // 保存
    save: function () {
        return window.__pkg__getLazyBundle('./dist/bundle-v0.3.4-bundle53.js','188')
    },

    // 立方体
    geometry: function () {
        return window.__pkg__getLazyBundle('./dist/bundle-v0.3.4-bundle54.js','189')
    }
...
window.__pkg__bundleSrc__['190']=function(){
    ...
    // 立方体
    geometry: function () {
        return window.__pkg__getLazyBundle('./dist/bundle-v0.3.4-bundle55.js','191')
    },

    // 修改器
    modify: function () {
        return window.__pkg__getLazyBundle('./dist/bundle-v0.3.4-bundle56.js','192')
    }
