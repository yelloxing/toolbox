...
window.__pkg__bundleSrc__['108']=function(){
    ...
    // 内置框架
    framework: function () {
        return window.__pkg__getLazyBundle('./dist/main-v0.3.1-bundle41.js','109')
    },

    // 代码编辑器
    editor: function () {
        return window.__pkg__getLazyBundle('./dist/main-v0.3.1-bundle42.js','110')
    },

    // WebGL
    webgl: function () {
        return window.__pkg__getLazyBundle('./dist/main-v0.3.1-bundle43.js','111')
    },

    // canvas
    canvas: function () {
        return window.__pkg__getLazyBundle('./dist/main-v0.3.1-bundle44.js','112')
    },

    // 颜色选择器
    "color-picker": function () {
        return window.__pkg__getLazyBundle('./dist/main-v0.3.1-bundle45.js','113')
    },

    // svg
    svg: function () {
        return window.__pkg__getLazyBundle('./dist/main-v0.3.1-bundle46.js','114')
    }
};
