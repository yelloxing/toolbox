...
window.__pkg__bundleSrc__['174']=function(){
    ...
    // 画布或图像大小
    size: function () {
        return window.__pkg__getLazyBundle('./dist/main-v0.3.1-bundle48.js','175')
    },

    // 保存
    save: function () {
        return window.__pkg__getLazyBundle('./dist/main-v0.3.1-bundle49.js','176')
    }
...
window.__pkg__bundleSrc__['177']=function(){
    ...
    // 工具箱
    tool: function () {
        return window.__pkg__getLazyBundle('./dist/main-v0.3.1-bundle50.js','178')
    },

    // 图层
    layer: function () {
        return window.__pkg__getLazyBundle('./dist/main-v0.3.1-bundle51.js','179')
    }
