...
window.__pkg__bundleSrc__['110']=function(){
    ...
    // 内置框架
    framework: function () {
        return window.__pkg__getLazyBundle('./dist/bundle-v0.3.4-bundle42.js','111')
    },

    // 代码编辑器
    editor: function () {
        return window.__pkg__getLazyBundle('./dist/bundle-v0.3.4-bundle43.js','112')
    },

    // WebGL
    webgl: function () {
        return window.__pkg__getLazyBundle('./dist/bundle-v0.3.4-bundle44.js','113')
    },

    // canvas
    canvas: function () {
        return window.__pkg__getLazyBundle('./dist/bundle-v0.3.4-bundle45.js','114')
    },

    // 颜色选择器
    "color-picker": function () {
        return window.__pkg__getLazyBundle('./dist/bundle-v0.3.4-bundle46.js','115')
    },

    // svg
    svg: function () {
        return window.__pkg__getLazyBundle('./dist/bundle-v0.3.4-bundle47.js','116')
    }
};
