...
window.__pkg__bundleSrc__['170']=function(){
    ...
    // 画布或图像大小
    size: function () {
        return window.__pkg__getLazyBundle('./dist/main-v0.3.0-bundle44.js','171')
    },

    // 保存
    save: function () {
        return window.__pkg__getLazyBundle('./dist/main-v0.3.0-bundle45.js','172')
    }
...
window.__pkg__bundleSrc__['173']=function(){
    ...
    // 工具箱
    tool: function () {
        return window.__pkg__getLazyBundle('./dist/main-v0.3.0-bundle46.js','174')
    },

    // 图层
    layer: function () {
        return window.__pkg__getLazyBundle('./dist/main-v0.3.0-bundle47.js','175')
    }
